...
@Controller
@RequestMapping("module/warehouse-transfer-recieve-items")
public class WarehouseTransferRecieveItemsController {
    ...
    public WarehouseTransferRecieveItemsController(TemplateEngine templateEngine) {
...
//    @PreAuthorize("hasAuthority('')")
    public ModelAndView index(@PathVariable(name = "warehouseProductId") Optional<Long> warehouseProductId,
        ...
        modelAndView.setViewName("/pages/modules/warehouse-product-transfers-recieve-items/index");
        return modelAndView;
    }
