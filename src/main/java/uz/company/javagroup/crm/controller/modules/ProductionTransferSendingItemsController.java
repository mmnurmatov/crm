...
@Controller
@RequestMapping("module/production-transfer-sending-items")
public class ProductionTransferSendingItemsController extends BaseController {
    ...
    public ProductionTransferSendingItemsController(TemplateEngine templateEngine) {
...
//    @PreAuthorize("hasAuthority('')")
    public ModelAndView index(@PathVariable(name = "productionProductId") Optional<Long> productionProductId,
        ...
        modelAndView.setViewName("/pages/modules/production-product-transfers-sending-items/index");
        return modelAndView;
    }


    // report for transfer sending section 1 for view

    @RequestMapping(path = "/transferSendingPDF/{productionProductId}", method = RequestMethod.GET)
    public ModelAndView createTransferSendingPDF(@PathVariable(name = "productionProductId") Optional<Long> productionProductId,
        ...
        modelAndView.setViewName("/pages/reports/transfer-sending/page-invoice-transfer-sending");
        return modelAndView;
    }


    // report for transfer sending section 2 for download
    @RequestMapping(path = "/transfer-sending-warehouse-pdf/{warehouseProductId}", method = RequestMethod.GET)
    public ResponseEntity<?> getTransferSendingPDF(@PathVariable(name = "warehouseProductId") Optional<Long> warehouseProductId,
        ...
        String orderHtml = templateEngine.process("/pages/reports/transfer-sending/warehouse-transfer-sending-product", context);
        ...
        return ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=transfer-sending.pdf")
