...
@Controller
@RequestMapping("module/warehouse-transfer-sending-items")
public class WarehouseTransferSendingItemsController {
    ...
    public WarehouseTransferSendingItemsController(TemplateEngine templateEngine) {
...
//    @PreAuthorize("hasAuthority('')")
    public ModelAndView index(@PathVariable(name = "warehouseProductId") Optional<Long> warehouseProductId,
        ...
        modelAndView.setViewName("/pages/modules/warehouse-product-transfers-sending-items/index");
        return modelAndView;
    }
    ...
    @RequestMapping(path = "/transferSendingPDF/{warehouseProductId}", method = RequestMethod.GET)
    public ModelAndView createTransferSendingPDF(@PathVariable(name = "warehouseProductId") Optional<Long> warehouseProductId,
